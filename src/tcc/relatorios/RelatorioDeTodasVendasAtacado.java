 ...
 * @author Breno-
 */
public class RelatorioDeTodasVendasAtacado {
   ...
   private static VendaDao vendaDao = new VendaDao();
    ...
    public static void gerarRelatorio(String nomeRelatorio) throws SQLException, JRException, FileNotFoundException {
        ...
        JasperReport report = JasperCompileManager.compileReport(RelatorioDeTodasVendasAtacado.class.getClassLoader().getResourceAsStream("jrxml/RelatorioDasRevendas.jrxml"));

...
public class RelatorioClientes {
    ...
    private static ClienteFisicoDao clienteDao = new ClienteFisicoDao();
    ...
    public static void gerarRelatorio(String nomeRelatorio) throws SQLException, JRException, FileNotFoundException {
        ...
        List<ClienteFisico> listaClientes = clienteDao.listarClientes();
        
        Map parameters = new HashMap();
   
        JasperReport report = JasperCompileManager.compileReport(RelatorioClientes.class.getClassLoader().getResourceAsStream("jrxml/RelatorioClientes.jrxml"));
        
        JasperPrint print = JasperFillManager.fillReport(report, parameters, new JRBeanCollectionDataSource(listaClientes));

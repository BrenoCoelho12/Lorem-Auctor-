 ...
 * @author Breno-
 */
public class RelatorioDeTodasVendasVarejo {
    ...
    public static void gerarRelatorio(String nomeRelatorio) throws SQLException, JRException, FileNotFoundException {
        ...
        List<MovimentoDiario> listaMovimentacao = MovimentacaoDao.listarMovimentacao();
        
        Map parameters = new HashMap();
   
        JasperReport report = JasperCompileManager.compileReport(RelatorioDeTodasVendasVarejo.class.getClassLoader().getResourceAsStream("jrxml/RelatorioMovimentacaoDiaria.jrxml"));

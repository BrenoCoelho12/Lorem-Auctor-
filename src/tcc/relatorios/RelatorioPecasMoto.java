 ...
 * @author Breno-
 */
public class RelatorioPecasMoto {
    ...
    public static void gerarRelatorio(String nomeRelatorio) throws SQLException, JRException, FileNotFoundException {
        ...
        List<Produtos> listaProdutosMoto = ProdutoDao.listarProdutosmoto();
        
        Map parameters = new HashMap();
    
        JasperReport report = JasperCompileManager.compileReport(RelatorioPecasMoto.class.getClassLoader().getResourceAsStream("jrxml/RelatorioPecasMoto.jrxml"));
        //PfdVenda.class.getResourceAsStream("tcc/jrxml/RelatorioPecasMoto"
        
        JasperPrint print = JasperFillManager.fillReport(report, parameters, new JRBeanCollectionDataSource(listaProdutosMoto));
